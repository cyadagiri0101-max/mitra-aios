...
import { G14CapacityEvaluationMetrics } from '../dto/g14-capacity.dto';

@Entity('g14_capacity_model_artifacts')
@Index(['tenantId', 'modelVersion'])
@Index(['tenantId', 'isActive'], { where: 'deleted_at IS NULL' })
export class G14CapacityModelArtifact {
  ...
  @Column({
    ...
    length: 50,
    name: 'model_type',
    default: 'RIDGE_CAPACITY_DEFICIT_REGRESSION',
  })
  modelType: string;
  ...
  evaluationMetrics: G14CapacityEvaluationMetrics;
