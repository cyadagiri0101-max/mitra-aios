...
import { CreateProcessPlanDto, UpdateProcessPlanDto } from '../dto/processplan.dto';
...
@Controller('planning/process-plans')
export class ProcessPlanController {
  constructor(private readonly service: ProcessPlanService) {}
  ...
  async update(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateProcessPlanDto>,
    @CurrentUser() user: AuthUser,
  ) {
