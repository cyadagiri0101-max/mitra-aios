...
import { PpapApqpStatus } from '../entities/ppap-apqp.entity';

@ApiTags('quality')
@ApiBearerAuth()
@UseGuards(JwtAuthGuard)
@Controller('quality/ppap-apqp')
export class PpapApqpController {
  constructor(private readonly service: PpapApqpService) {}

  @UseGuards(RolesGuard)
  @Roles('ADMIN', 'MANAGEMENT', 'QUALITY', 'ENGINEERING')
  @Get()
  async findAll(@Query() q: PaginationDto & { status?: PpapApqpStatus; projectId?: string }, @CurrentUser() user: AuthUser) {
