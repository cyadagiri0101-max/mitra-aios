...
import { MsaStatus } from '../entities/msa-study.entity';

@ApiTags('quality')
@ApiBearerAuth()
@UseGuards(JwtAuthGuard)
@Controller('quality/msa')
export class MsaStudyController {
  constructor(private readonly service: MsaStudyService) {}

  @UseGuards(RolesGuard)
  @Roles('ADMIN', 'MANAGEMENT', 'QUALITY')
  @Get()
  async findAll(@Query() q: PaginationDto & { status?: MsaStatus; projectId?: string }, @CurrentUser() user: AuthUser) {
