...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/dispatch',      label: 'Dispatch',      icon: Truck,           roles: ['ADMIN','MANAGEMENT','SALES','DESIGN','PLANNING','PRODUCTION','QUALITY'] },
  { path: '/service',       label: 'Service',       icon: Wrench,          roles: ['ADMIN','MANAGEMENT','SALES','SERVICE','QUALITY','DESIGN','PLANNING','PRODUCTION'] },
